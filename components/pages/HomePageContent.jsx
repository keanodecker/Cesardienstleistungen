    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        ...
        <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden bg-slate-100">
          {/* Floating words – nur auf Desktop sichtbar */}
          <div className="hidden md:block absolute inset-0 pointer-events-none select-none overflow-hidden">
            <motion.div initial={{ x: -50 }} animate={{ x: 0 }} transition={{ duration: 1, delay: 0.2 }} className="absolute top-[15%] left-[20%] text-5xl font-bold text-accent-green opacity-80 rotate-[-5deg]">
              Fürsorge
            </motion.div>
            <motion.div initial={{ y: -50 }} animate={{ y: 0 }} transition={{ duration: 1, delay: 0.4 }} className="absolute top-[20%] right-[25%] text-6xl font-bold text-accent-cyan opacity-60 rotate-[8deg]">
              Familie
            </motion.div>
            <motion.div initial={{ x: 50 }} animate={{ x: 0 }} transition={{ duration: 1, delay: 0.6 }} className="absolute bottom-[25%] right-[20%] text-5xl font-bold text-accent-green opacity-70 rotate-[-3deg]">
              Begleitung
            </motion.div>
            <motion.div initial={{ y: 50 }} animate={{ y: 0 }} transition={{ duration: 1, delay: 0.8 }} className="absolute bottom-[20%] left-[25%] text-7xl font-bold text-accent-cyan opacity-90 rotate-[5deg]">
              Bau
            </motion.div>
            <motion.div initial={{ scale: 0.5 }} animate={{ scale: 1 }} transition={{ duration: 1, delay: 1 }} className="absolute top-[45%] left-[10%] text-5xl font-bold text-accent-cyan opacity-70 rotate-[-15deg]">
              Event
            </motion.div>
          </div>
          ...
          <div className="relative z-10 container mx-auto px-6 text-center flex flex-col items-center">
            ...
            <motion.div initial={{ y: 10 }} animate={{ y: 0 }} transition={{ duration: 0.6, delay: 0.3 }} className="mt-4 md:mt-8">
              <p className="text-base sm:text-xl md:text-2xl font-medium text-muted-foreground italic px-4">
